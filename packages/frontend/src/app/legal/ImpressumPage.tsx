          ...
          <div className="space-y-6 text-foreground">
            <section>
              ...
              <div className="space-y-1">
                <p>
                  <strong>{t('legal.impressum.provider.name')}:</strong> Maik Maibaum
                </p>
                <p>
                  <strong>{t('legal.impressum.provider.address')}:</strong> Fischerinsel 5
                </p>
                <p>
                  <strong>{t('legal.impressum.provider.city')}:</strong> 10179 Berlin
                </p>
                <p>
                  <strong>{t('legal.impressum.provider.country')}:</strong> Deutschland
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-1">
                <p>
                  <strong>{t('legal.impressum.contact.email')}:</strong> lamaberlin@gmail.com
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <h3 className="font-semibold mt-4 mb-2">
                {t('legal.impressum.disclaimer.content.title')}
              </h3>
              <p className="mb-4">{t('legal.impressum.disclaimer.content.description')}</p>

              <h3 className="font-semibold mt-4 mb-2">
                {t('legal.impressum.disclaimer.links.title')}
              </h3>
