              ...
              <form onSubmit={handleInviteSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={t('welcomeChoice.newAccount.invitePlaceholder', { defaultValue: 'Enter your invite code' })}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  {t('welcomeChoice.import.manualCode', { defaultValue: 'Enter Backup Code Manually' })}
                </Button>
              </div>
            </div>
          </Card>
