            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-foreground leading-relaxed">
                {t('onboarding.parentalConsent.aiExplained', {
                  defaultValue:
                    "Every task is dynamically generated by AI to match your child's age, grade level, and learning pace. Content adapts to their progress, providing the right level of challenge at the right time.",
                })}
              </p>
            </div>
          </div>
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-foreground leading-relaxed">
                {t('onboarding.parentalConsent.contentExplained', {
                  defaultValue:
                    "All content is filtered and validated to ensure it's appropriate for your child's age. Our prompts are designed to generate educational, safe content focused purely on learning.",
                })}
              </p>
            </div>
          </div>
