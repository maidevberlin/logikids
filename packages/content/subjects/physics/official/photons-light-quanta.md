---
id: photons-light-quanta
name: Photons and Light Quanta
description: 'Quantum nature of light - photoelectric effect and photon properties'
grade: 12
ages:
  - 17
  - 18
...
difficulty: hard
learning_objectives:
  - Understand photoelectric effect and its explanation
  - Apply photon energy equation (E = h·f)
  - Recognize limitations of classical wave model
...
example_tasks:
  ...
  - Determine the threshold frequency for photoelectric emission given a work function
  - Explain why increasing light intensity doesn't affect the maximum kinetic energy of photoelectrons
real_world_context: 'Solar cells, photomultiplier tubes, night vision devices, photodetectors, LED technology, X-ray generation, quantum cryptography, optical sensors'
---
...
```mermaid
graph TD
    A[Incident Photon E = h·f] -->|Absorbed by electron| B{Energy Comparison}
    B -->|E < W_A| C[No electron emission]
    B -->|E ≥ W_A| D[Electron emitted]
    D -->|Energy partition| E[Work function W_A]
    D -->|Energy partition| F[Kinetic energy E_kin]
    E -->|Used to escape| G[Overcome binding]
    F -->|Remaining energy| H[E_kin = h·f - W_A]
...
```mermaid
graph LR
    A[Classical Wave Theory] -->|Predicts| B[Continuous energy absorption]
    B -->|Should lead to| C[Emission after delay]

    D[Photon Theory] -->|Predicts| E[Quantized energy packets]
    E -->|Leads to| F[Instantaneous emission]

    G[Experimental Reality] -->|Confirms| F
    G -->|Contradicts| C

    H[Threshold Frequency] -->|Classical cannot explain| I[Why low f fails]
    J[Photon Model] -->|Explains naturally| I
